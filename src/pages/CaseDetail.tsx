...
const caseCopy: Record<number, {
  ...
  2: {
    intro: "Strona dla studia treningowego Akademia Ruchuskupiona na szybkim kontakcie i czytelnej ofercie. Zaprojektowana tak, by klient od razu widział zakres usług i mógł umówić trening jednym kliknięciem.",
    ...
    testimonial: {
      text: "Ze strony jestem bardzo zadowolonyzrobione szybko i dokładnie tak, jak chciałem. Na każdym etapie miałem info o zmianach. Najważniejsze: klienci łatwiej do mnie trafiają.",
  ...
  3: {
    intro: "Strona sprzedażowa dla trenera Eryka Jankowskiegonastawiona na sprzedaż planów online bez konieczności pisania na priv. Wideo, opinie i płatności w jednym miejscu.",
    goal: "Sprzedaż planów online bez zbędnych wiadomości na priv.",
    result: "Wideo pod sekcją główną + opinie i metamorfozy, do tego płatności onlinezakup w kilka kliknięć prosto na stronie.",
    testimonial: {
  ...
  5: {
    intro: "Wizytówka online dla trenera Bartka Węgielnikaspójna z jego Instagramem, by klienci od razu rozpoznawali markę. Jasna oferta i formularz kontaktu zamiast DMs.",
    goal: "Ułatwić poznanie oferty i zostawienie kontaktu.",
    result: "Wizytówka spójna z Instagramem, jasna karta oferty ('Co dostajesz' i 'Dla kogo') oraz formularz w kluczowych miejscachszybkie zapytania bez DMs.",
    testimonial: {
      text: "Wreszcie mogę pokazać ofertę w jednym miejscu i zbierać zapytania bez odsyłania ludzi do DM. Strona wygląda jak mój Instagramklienci od razu kojarzą, że to ja.",
  ...
  4: {
    intro: "Strona dla trenera Marcela Kaczmarkaprzejście od treningów 1:1 do sprzedaży planów online. Skupiona na pokazaniu efektów podopiecznych i prowadzeniu do wyboru planu.",
  ...
  1: {
    intro: "Wizytówka dla trenera Artura Stawiakaprosta strona z czytelną ofertą i CTA 'Umów konsultację'. Zaprojektowana, by zapełnić grafik i ułatwić przejście na pełen etat.",
  ...
  6: {
    ...
    testimonial: {
      text: "Zależało nam na czymś prostym i eleganckim. Strona idealnie spełnia swoją rolęklienci od razu widzą czym się zajmujemy i mają łatwy kontakt.",
...
const imageDescriptions = [
  ...
  },
  {
    ...
    description: "Realne opinie klientów i efekty współpracy. Zdjęcia przed/po, cytaty i ocenywszystko, co potwierdza skuteczność i buduje wiarygodność."
  },
  {
    title: "Struktura treści i nawigacja",
    description: "Przejrzysty układ strony, który prowadzi odwiedzającego przez kolejne sekcje. Logiczna ścieżka od zainteresowania do kontaktubez zbędnych kliknięć."
  },
  {
    title: "Sekcja kontaktowa",
    description: "Prosty formularz kontaktu lub przycisk do umówienia wizyty. Bez zbędnych póltylko to, co potrzebne. Wyraźne CTA i szybka ścieżka do działania."
  },
];
...
export function CaseDetailPage() {
  ...
  return (
    <div className="min-h-dvh bg-black text-white">
      ...
      <ProjectDetails
        goal={copy?.goal || "Skoncentrowany na osobach trenującychprosta ścieżka do kontaktu."}
