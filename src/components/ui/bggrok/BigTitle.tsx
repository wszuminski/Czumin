    ...
    <div className="absolute inset-0 z-0 flex select-none flex-col items-center justify-end">
      <div className="pointer-events-auto container flex max-w-4xl flex-col items-center px-4 pb-28 text-center sm:pb-32">
        <div className="relative">
          {/* Blurred glow layer — creates the "emerging from mist" effect */}
          <span
            aria-hidden="true"
            className="heading-grok-glow absolute inset-0 leading-none tracking-tight text-[clamp(64px,18vw,220px)] md:text-[clamp(120px,22vw,420px)]"
            style={{
              fontWeight: 700,
          ...
          <h1
            className="heading-grok relative leading-none tracking-tight text-[clamp(64px,18vw,220px)] md:text-[clamp(120px,22vw,420px)]"
            style={{
              fontWeight: 700,
              letterSpacing: "-0.02em",
              fontFamily: '"Share Tech", var(--font-heading)',
